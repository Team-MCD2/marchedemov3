const SITE = {
  ...
  shortPitch: "Le plus grand supermarché ethnique d'Occitanie · 20 000+ références · Ouvert 7j/7",
...
const MAGASINS = {
  "toulouse-sud": {
    ...
    mapsEmbed: "https://www.openstreetmap.org/export/embed.html?bbox=1.4004%2C43.5811%2C1.4104%2C43.5871&layer=mapnik&marker=43.5841%2C1.4054",
    mapsLink: "https://maps.google.com/?q=5+rue+Joachim+du+Bellay+31100+Toulouse",
    photo: "/images/magasins/toulouse-sud.jpg",
    badge: "Supermarché",
    accroche: "Votre grand supermarché au cœur de Toulouse Sud Cépière.",
    description: "Votre supermarché Marché de Mo' à Toulouse. Situé à l'entrée de la sortie périphérique Cépière, 1 200 m² d'espace de vente pour répondre à tous vos besoins.",
    atouts: [
...
const RAYONS = {
  "boucherie-halal": {
    ...
    description: "Viandes, volailles et charcuteries 100% halal certifiées, sans électronarcose. Arrivage quotidien, traçabilité rigoureuse.",
    longDescription: "Toutes nos viandes sont halal certifiées, abattues sans électronarcose. On travaille les carcasses en interne : vous n'achetez que ce qui a été découpé du jour. Agneau, bœuf, volaille, charcuterie — traçabilité complète et prix affichés, week-end compris.",
    image: "/images/rayons/boucherie-halal.jpg",
    imageAlt: "Boucherie halal Marché de Mo' Toulouse — viande fraîche travaillée sur carcasse",
  ...
  "fruits-legumes": {
    ...
    description: "Primeurs sélectionnés chaque matin. Bananes plantains, ignames, manioc, mangues, épices fraîches — le rayon le plus complet de l'agglomération toulousaine.",
    longDescription: "Livraison tous les matins depuis Rungis et les marchés directs internationaux. Bananes plantains, ignames, manioc, mangues, feuilles de manioc, piments frais — 120 références exotiques qu'on ne trouve pas en grande surface classique, au prix du marché.",
  ...
  "epices-du-monde": {
    ...
    description: "Une offre d'épices et de thés sans équivalent dans la région toulousaine. Mélanges signatures, épices rares, thés sélectionnés.",
    longDescription: "Ras el hanout, za'atar, curry de Madras, piment berbère, safran iranien, cardamome verte — mélanges montés chez nous, épices rares importées en direct. Thés du Maghreb, de Turquie et d'Asie. L'offre la plus complète de l'agglomération, sans la marge d'une épicerie fine.",
  ...
  "saveurs-afrique": {
    ...
    description: "Produits de la gastronomie africaine et créole : plats cuisinés, conserves, condiments, boissons et spécialités introuvables ailleurs.",
    longDescription: "Afrique de l'Ouest, Afrique centrale, Maghreb, Antilles. Gombo, fufu, sauce graine, attiéké, bissap, ginger beer, plantain précuit, huile de palme rouge, poisson fumé — les produits qu'il fallait aller chercher à Paris sont maintenant à Toulouse, au prix juste.",
    ...
    imageAlt: "Rayon saveurs africaines et créoles Marché de Mo' Toulouse — produits du continent africain",
    culturel: true,
    ordre: 4,
    icone: "africa",
  ...
  "saveurs-asie": {
    ...
    description: "Épicerie asiatique complète : sauces, pâtes, riz, nouilles, produits frais asiatiques. Authenticité et packaging d'origine.",
    longDescription: "Sauce soja Kikkoman, nuoc-mam, sambal oelek, gochujang, sauce d'huître, pâte de miso, riz jasmin, nouilles udon fraîches, kimchi, galettes de riz, feuilles de nori. Import direct, emballages d'origine — donc des prix plus bas que les épiceries spécialisées du centre-ville.",
  ...
  "saveur-mediterranee": {
    ...
    description: "Olives de Provence et du Maghreb, produits orientaux, turcs, levantins. L'épicerie méditerranéenne dans toute sa richesse.",
    longDescription: "Olives du Maghreb et de Provence, huiles d'olive vierges extra, harissa, couscous, semoule fine et moyenne, feuilles de brick, pâtes de dattes, confitures de coing, fromages levantins. La Méditerranée entière, au prix du supermarché.",
  ...
  "saveur-sud-amer": {
    ...
    description: "Épicerie, conserves, boissons et spécialités d'Amérique Latine. Fruits exotiques et piments colorés de la région.",
    longDescription: "Arepas précuites, dulce de leche, tortillas de maïs, haricots noirs, piments habanero et chipotle, farine de manioc, maté, guaraná, yerba. Les ingrédients qu'il faut pour cuisiner latino à la maison — sans faire le tour de Toulouse.",
    ...
    imageAlt: "Plateau d'ingrédients latino-américains : plantain, avocat, arepa, orange, salsa et coriandre",
    culturel: true,
    ordre: 7,
    icone: "tropical",
  ...
  "balkans-turques": {
    ...
    description: "Épiceries, fromages, charcuteries halal, conserves et boissons des Balkans et de Turquie.",
    longDescription: "Ayran, kefir, fromage blanc turc, feta bulgare, pastırma halal, soudjouk, börek, baklava, lokoum, café turc, délices de rose. L'épicerie balkano-turque qui manquait à Toulouse, avec les vrais emballages d'origine.",
    image: "/images/rayons/balkans-turques.jpg",
    imageAlt: "Rayon Balkans et Turquie Marché de Mo' Toulouse — Adana kebab, börek, fromages blancs",
    culturel: true,
    ordre: 8,
    icone: "ottoman",
  ...
  "produits-courants": {
    ...
    description: "Prix cassés sur les produits du quotidien. Notre espace déstockage propose des réductions significatives pour tous les budgets.",
    longDescription: "Notre espace déstockage : produits d'entretien, hygiène, épicerie sucrée et salée — aux prix les plus bas du magasin. Fin de série, fin de stock ou arrivage exceptionnel : les bonnes affaires changent chaque semaine.",
  ...
  surgeles: {
    ...
    description: "Large sélection de surgelés du monde entier : plats cuisinés ethniques, viandes halal surgelées, légumes et snacking.",
    longDescription: "Samoussas, bricks, nems, keftas halal, poulet yassa, mafé, rouleaux de printemps, naans au fromage, pizzas halal, légumes vapeur, glaces du monde. Le rayon qui dépanne quand il n'y a pas le temps — sans transiger sur l'origine.",
...
const RAYONS_LIST = Object.values(RAYONS).sort((a, b) => a.ordre - b.ordre);
const ENGAGEMENTS = [
  {
    titre: "Urgence alimentaire",
    resume: "Dons réguliers aux banques alimentaires locales.",
    description: "Nous menons des dons réguliers auprès des associations toulousaines engagées dans la lutte contre la précarité alimentaire, en coordination étroite avec les banques alimentaires de Haute-Garonne.",
    icone: "heart"
  },
  {
    titre: "Diversité & Inclusion",
    resume: "Un environnement équitable et inclusif.",
    description: "Notre équipe compte plus de 24 salariés âgés de 19 à 56 ans, issus de parcours très variés. 90% d'entre eux n'avaient pas d'emploi avant leur embauche chez nous — un engagement concret pour la réinsertion.",
    icone: "people"
  },
  {
    titre: "Sport",
    resume: "Soutien aux associations sportives locales.",
    description: "Nous accompagnons plusieurs clubs et associations sportives de l'agglomération toulousaine, parce que le sport est un formidable vecteur de lien social et d'inclusion.",
    icone: "trophy"
  },
  {
    titre: "Personnes dépendantes",
    resume: "Soutien aux personnes âgées de Toulouse.",
    description: "Partenariats avec les structures d'accompagnement des personnes âgées de l'agglomération : dons alimentaires, accueil adapté, accompagnement en magasin.",
    icone: "care"
  }
];

export { ENGAGEMENTS as E, MAGASINS as M, RAYONS as R, SITE as S, RAYONS_LIST as a, SOCIAL as b };
