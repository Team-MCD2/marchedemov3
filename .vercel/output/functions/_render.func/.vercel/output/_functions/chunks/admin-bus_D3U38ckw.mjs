 ...
 * doesn't crash).
 */
function publishAdminEvent(type, extra = {}) {
 ...
 */
function subscribeAdminEvents(types, handler) {
  if (typeof window === "undefined") return () => {};
...
export { ADMIN_EVENT as A, publishAdminEvent as p, subscribeAdminEvents as s };
